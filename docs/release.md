...
- `artifacts/autoskip-1.0.1.zip`: package with `manifest.json` at the root, no tests/source maps/development code.
...
4. Tag a reviewed commit (example for an alpha: `v1.0.1-alpha.1`) and push that exact tag.
