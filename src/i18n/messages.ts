...
const EN: Record<MessageKey, string> = {
  ...
  "toast.undoPaused": "This action is paused for this session",
  "toast.undone":
    "Returned to before the skip. This action is paused for this session.",
  "prompt.pause": "Pause automation",
